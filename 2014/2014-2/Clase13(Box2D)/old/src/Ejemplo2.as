package 
{
	 ...
	 * @author Luis
	 */
	public class Ejemplo2 extends Sprite
	{
		...
		private function added(e:Event):void 
		{
			...
			addBox(800,340,20,800,b2Body.b2_staticBody);
             ...
             for (var i:int=0; i<10; i++) {
                kinematicSphere(640*(i%2),352,10,(1-2*(i%2))*(Math.random()*10+5));
            }
        ...
        private function update(e:Event):void {
		 ...
		 private function kinematicSphere(pX:int,pY:int,r:Number,hV:Number):void {
            var bodyDef:b2BodyDef=new b2BodyDef();
            bodyDef.position.Set(pX/worldScale,pY/worldScale);
			...
			theKinematic.SetUserData( { name:'coin' } );
